...
(function () {
    ...
    var translations = {
        en: {
            ...
            bootErrorMsg: "Even AI needs a coffee break. Tap Reload and I\u2019ll be right back.",
            bootErrorReload: "Reload",
        ...
        es: {
            ...
            bootErrorMsg: "Hasta la IA necesita un descanso. Pulsa Recargar y vuelvo enseguida.",
            bootErrorReload: "Recargar",
        ...
        pt: {
            ...
            bootErrorMsg: "At\u00e9 a IA precisa de um caf\u00e9. Toque em Recarregar e j\u00e1 volto.",
            bootErrorReload: "Recarregar",
        ...
        fr: {
            ...
            bootErrorMsg: "M\u00eame l\u2019IA a besoin d\u2019une pause caf\u00e9. Touchez Recharger et je reviens tout de suite.",
            bootErrorReload: "Recharger",
        ...
        zh: {
            ...
            bootErrorMsg: "\u8fde AI \u4e5f\u9700\u8981\u4f11\u606f\u4e00\u4e0b\u3002\u70b9\u201c\u91cd\u65b0\u52a0\u8f7d\u201d\uff0c\u6211\u9a6c\u4e0a\u5c31\u56de\u6765\u3002",
            bootErrorReload: "\u91cd\u65b0\u52a0\u8f7d",
        ...
        ja: {
            ...
            bootErrorMsg: "AI\u3060\u3063\u3066\u3072\u3068\u4f11\u307f\u304c\u5fc5\u8981\u3067\u3059\u3002\u300c\u518d\u8aad\u307f\u8fbc\u307f\u300d\u3092\u62bc\u305b\u3070\u3059\u3050\u623b\u308a\u307e\u3059\u3002",
            bootErrorReload: "\u518d\u8aad\u307f\u8fbc\u307f",
    ...
    window.cnStaticShellI18n = {
        ...
        applyIndex: function () {
            ...
            // The Blazor "unhandled error" bar (see #blazor-error-ui in index.html).
            // Localize CompanioNita's line and the reload label. The framework binds
            // its reload handler by CSS class, so changing only the text is safe.
            // applyIndex() runs in <head>, before <body> (and the bar) are parsed,
            // so defer this part until the DOM is ready.
            var applyErrorBar = function () {
                var bootMsg = document.getElementById('cn-error-msg');
                if (bootMsg) bootMsg.textContent = t('bootErrorMsg');
                var bootReload = document.querySelector('#blazor-error-ui .reload');
                if (bootReload) bootReload.textContent = t('bootErrorReload');
            };

            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', applyErrorBar);
            } else {
                applyErrorBar();
            }
        }
