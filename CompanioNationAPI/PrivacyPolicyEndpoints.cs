...
/// <summary>
/// Server-rendered Privacy Policy page.
/// Serves full HTML so bots/crawlers (Google Play, search engines) can read
/// the content without executing JavaScript (Blazor WASM).
/// Lives in the open-source Core repo so the policy is fully transparent.
/// Called from Services Program.cs via <c>app.MapPrivacyPolicyEndpoints()</c>.
/// </summary>
public static class PrivacyPolicyEndpoints
{
    /// <summary>
    /// Registers the <c>/PrivacyPolicy</c> server-rendered endpoint.
    /// </summary>
    /// <param name="app">The endpoint route builder.</param>
    /// <param name="gtmId">Optional Google Tag Manager container ID for analytics.</param>
    public static IEndpointRouteBuilder MapPrivacyPolicyEndpoints(this IEndpointRouteBuilder app, string? gtmId = null)
    {
        app.MapGet("/PrivacyPolicy", () => Results.Text(RenderPrivacyPolicyHtml(gtmId), "text/html; charset=utf-8"));
        return app;
    }

    private static string RenderPrivacyPolicyHtml(string? gtmId)
    {
        var gtmHead = Util.GtmHeadScript(gtmId);
        var gtmBody = Util.GtmBodyNoscript(gtmId);
...
<head>
  ...
  <title>Privacy Policy — CompanioNation™</title>
  <meta name="description" content="Privacy Policy and Terms of Service Agreement for CompanioNation™ — the first open-source dating app." />
  {{gtmHead}}
  <style>
...
<body>
  ...
  <ul>
    <li><strong>Mail:</strong> Send a written request to us at the address provided below. Please include sufficient information to verify the legitimacy of your request, such as your full name, email address associated with your account, and any other relevant details.</li>
  </ul>

  <p><strong>Processing Deletion Requests:</strong> Upon receiving a deletion request, we will:</p>
  <ul>
    <li>Verify your identity to ensure the legitimacy of the request.</li>
    <li>Assess the request to determine if any legal obligations require us to retain certain information.</li>
    <li>Allocate a processing period of up to 60 days to ensure there are no pending legal obligations or investigations that necessitate retaining your information.</li>
    <li>If retention is necessary, we will inform you of the reasons and the extent of data that cannot be deleted.</li>
    <li>Proceed with deletion of all other personal information that is not subject to legal retention.</li>
  </ul>
  <p>We strive to respond to all deletion requests within 60 days of receipt. If additional time is needed, we will inform you accordingly.</p>
  ...
  <p>
    ...
    1188 Pendrell Street, Apartment 405<br />
    Vancouver, BC, V6E 4P8<br />
    Email: <a href="mailto:abuse@companionation.com">abuse@companionation.com</a><br />
    Phone: 604-657-2386
  </p>
  ...
  <p>In such cases, even if you have requested deletion of your personal information, we may retain certain data to comply with these obligations.</p>

  <p>By using CompanioNation™, you acknowledge that you have read and understood this Privacy Policy and Terms of Service Agreement and agree to be bound by its terms.</p>

  <footer><a href="/">Back to CompanioNation</a></footer>
</body>
</html>
""";
    }
